...
def main():
    ...
    count_rows("identity_baseline_counts_v0.37.csv","Identity_Baseline_State",ledger);count_rows("instrument_baseline_counts_v0.37.csv","Instrument_Gate_Baseline_State",ledger);count_rows("mapping_baseline_counts_v0.37.csv","Mapping_Baseline_State",ledger);count_rows("history_baseline_counts_v0.37.csv","History_Evidence_State",ledger);count_rows("liquidity_baseline_counts_v0.37.csv","Liquidity_Evidence_State",ledger);count_rows("scalable_baseline_counts_v0.37.csv","Scalable_Tradeability_Status",ledger);count_rows("prior_eligibility_counts_v0.37.csv","Prior_Eligibility_State",ledger)
